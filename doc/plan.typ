...
Tyrime YAG sintezės reakcijai modeliuoti bus sukurtas kompiuterinis modelis pagrįstas egzistuojančiu matematiniu modeliu.

== Modelio parametrų optimizavimas

Naudojant eksperimentinius duomenis, standartinių algoritmų pagalba bus nustatyti optimalūs modelio parametrai su kuriais modelio rezultatai tiksliausiai atitinka eksperimento duomenis.

== Skaičiavimų lygiagretinimas

Dėl didelės duomenų ir skaičiavimų apimties, kompiuterinis modelis bus pritaikytas veikti lygiagrečiai and MIF superkompiuterio infrastruktūros.
