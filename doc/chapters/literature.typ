...
Yra ištirta, kaip galutinio produkto išeiga priklauso nuo dalelių dydžio @kupp2014particle -- nustatyta, kad optimaliausi dalelių dydžiai yra 110 nm itrio oksido dalelėms, o aliuminio oksido -- 90 nm. Tokiu atveju, vykdant reakciją prie 1450 $degree$C galima pasiekti 93% YAG turinio pagal tūrį.

Kaitinant mišinį dalelių paviršių sandūrose pradeda formuotis tarpiniai junginiai -- itrio aliuminio perovskitas (YAP) bei monoklininis itrio aluminatas (YAM), iš kurių galiausiai formuojasi itrio aliuminio granatas (YAG). Jei reakcija vykdoma per mažoje temperatūroje, tarpiniai junginiai YAP ir YAM iki galo nesureaguoja, o tai lemia prastą YAG kristalo kokybę.

Yra žinoma, kad norint paspartinti eksperimento eigą, chemikai periodiškai ištraukia mišinį iš krosnies ir žemesnėje temperatūroje atlieka mechaninį maišymą. Tokiu būdu yra atskleidžiamas dar nesureagavęs dalelių paviršių plotas, dėl kurio kaitinimo metu produktas formuojasi greičiau.
...
Cheminės reakcijos metu produktas formuojasi skirtingų medžiagų dalelių sandūroje, todėl pradinis medžiagų išsidėstymas erdvėje daro didelę įtaką produkto sintezės greičiui, todėl reikšminga modeliuoti ne molinę medžiagų masės priklausomybę nuo laiko, o medžiagų molinės koncentracijos pasiskirstymą erdvėje.

Fiziniai šio modelio parametrai, apibūdinantys medžiagų difuzijos ir reakcijos greičius, buvo nustatyti iš ribotų eksperimentinių duomenų, apibūdinančių reakcijos trukmę taikant kietafazės reakcijos ir zolio gelio metodus @mackeviciusCloserLookComputer2012 @ivanauskasComputationalModellingYAG2009.
...
Verta paminėti, kad minėti tyrimai modeliuoja supaprastintą cheminę reakciją, kurios metu YAG formuojasi tiesiogiai iš metalų oksidų. Šiame tyrime konstruosime papildytą matematinį modelį, kuris apima ir tarpinių junginių sintezę.

Straipsniuose @ivanauskasComputationalModellingYAG2009 @mackeviciusCloserLookComputer2012 @ivanauskasModellingSolidState2005a sistema sprendžiama standartiniu Eulerio metodu (_angl. Euler method_), tačiau dviejų dimensijų modeliams egzistuoja efektyvesni metodai, pavyzdžiui, neišreikštinis kintamosios krypties metodas (_angl. alternating direction implicit, ADI_), kurį pritaikius kartu su laiko žingsnio didinimo strategija galima efektyviai modeliuoti eksponentiškai didesnes erdves su tokia pačia diskrečių taškų rezoliucija @vaicekauskas2025yag.

Yra žinoma, kad šioje sintezės reakcijoje formuojasi tarpiniai junginiai -- itrio aliuminio perovskitas (YAP) bei monoklininis itrio aluminatas (YAM) @kupp2014particle, tačiau šis modelis į tai neatsižvelgia. Jei krosnies temperatūra nėra pakankamai aukšta, šie dariniai reakcijos eigoje nedingsta, o tai ženkliai sumažina kristalo kokybę.
